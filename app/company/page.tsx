    ...
    <>
      ...
      <section className="band"><div className="container">
        ...
        <div className="band-body" data-reveal>
          ...
          <p>人の心に届くためには、相手の理解と同じだけ、自己理解が欠かせません。しかしそのすべを持たないまま、認識のGAPに苦しみ、半ば諦めてしまう人が少なからずいます。だから私たちは、組織が前へ進むための「次の一手」を示すプロダクトを届けます。</p>
        </div>
      </div></section>
      ...
      <section className="band ink"><div className="container">
        ...
        <div className="band-body" data-reveal>
          ...
          <p>経営者の迷いを断ち切り、次の一手を示し、その後のアクションまで踏み出せる。そんなプロダクトとサービスを、私たちは開発しつづけます。</p>
          <Link href="/services" className="text-link">プロダクトを見る →</Link>
        </div>
      </div></section>
